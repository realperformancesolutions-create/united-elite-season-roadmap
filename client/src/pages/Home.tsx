...
const roadmap: RoadmapItem[] = [
  ...
  // -- OCTOBER ---------------------------------------------------------------
  {
    ...
    description:
      "PYRAMID CHOREOGRAPHY BEGINS THIS MONTH. BY THIS POINT, ALL STUNT SEQUENCES AND INDIVIDUAL SKILL SELECTIONS SHOULD BE SOLIDIFIED, ALLOWING COACHES TO SHIFT FULL FOCUS TO PYRAMID DESIGN. IF COACHES HAVE PROPERLY PREPARED THEIR ATHLETES THROUGHOUT THE SEASON, PYRAMID IS SIMPLY AN EXTENSION OF THE STUNT SKILLS ALREADY MASTERED -- AND THIS PROCESS SHOULD FEEL LIKE A NATURAL AND STRAIGHTFORWARD PROGRESSION.",
    icon: Activity,
  },
  {
    month: "OCTOBER",
  ...
  },
  {
    ...
    description:
      "JUMPS IN MAX #S SINGLE TOE, DOUBLE JUMP SEQUENCE AND ANY JUMP NOT PERFORMED. IE: LEFT HURDLER OR PIKE (INCLUDING NON-JUMPERS) * #1. VIDEO OF JUMPS PERFORMED * #2. INDIVIDUAL COLLAGE",
