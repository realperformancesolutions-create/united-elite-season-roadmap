...
const roadmap: RoadmapItem[] = [
  ...
  },
  {
    ...
    description: "BASELINE JUMP MEASURABLE — ESTABLISHES THE INDIVIDUAL JUMP BASELINE THAT WILL BE TRACKED FOR IMPROVEMENT THROUGHOUT THE SEASON.",
  ...
  },
  {
    month: "OCTOBER",
    window: "10/1",
    title: "OCTOBER — PYRAMID CHOREOGRAPHY MONTH",
    category: "PYRAMID CHOREO MONTH",
    description: "PYRAMID CHOREOGRAPHY BEGINS THIS MONTH. BY THIS POINT, ALL STUNT SEQUENCES AND INDIVIDUAL SKILL SELECTIONS SHOULD BE SOLIDIFIED, ALLOWING COACHES TO SHIFT FULL FOCUS TO PYRAMID DESIGN. IF COACHES HAVE PROPERLY PREPARED THEIR ATHLETES THROUGHOUT THE SEASON, PYRAMID IS SIMPLY AN EXTENSION OF THE STUNT SKILLS ALREADY MASTERED — AND THIS PROCESS SHOULD FEEL LIKE A NATURAL AND STRAIGHTFORWARD PROGRESSION.",
    icon: Activity,
  },
  {
    month: "OCTOBER",
